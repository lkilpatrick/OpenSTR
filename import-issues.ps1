...
$issues = @(
    ...
    @{file="007_*.md"; title="Seed database with properties, rooms, standards, and all My STR Property tasks"; milestone="M2: Database Schema & Seed Data"; labels="database,seed-data"},
