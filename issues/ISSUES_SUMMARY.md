# GitHub Issues — Ocean View BNB Manager
...
- [ ] **#7** Seed database with properties, rooms, standards, and all Ocean View BNB tasks _(deps: #5, #6)_
...
gh issue create --repo $REPO --title "Seed database with properties, rooms, standards, and all Ocean View BNB tasks" --milestone "M2: Database Schema & Seed Data" --label "database" --label "seed-data" --body-file issues/007_*.md
